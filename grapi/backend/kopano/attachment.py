...
from . import message
from .message import EmbeddedMessageResource
...
class AttachmentResource(Resource):
    ...
    def on_get_embedded_item_by_id(self, req, resp, itemid, attachmentid):
        ...
        response(embedded_item, EmbeddedMessageResource.fields)
...
class ItemAttachmentResource(AttachmentResource):
    ...
    relations = {
        'item': lambda attachment: (attachment.item, EmbeddedMessageResource),
    }
